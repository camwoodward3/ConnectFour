...
public class GameState
{
	...
	public List<(int Player, int Column)> MoveHistory { get; private set; } = new();
	public string BoardColor { get; set; } = "#ffff00"; // Default white
public string Player1Color { get; set; } = "#ff0000"; // Red
public string Player2Color { get; set; } = "#0000ff"; // Blue
	...
	public byte PlayPiece(int column)
	{
		...
		TheBoard[landingSpot] = CurrentPlayerTurn;

		MoveHistory.Add((CurrentPlayerTurn, column));
